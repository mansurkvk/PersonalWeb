  ...
  return (
    <div className="mx-auto grid min-h-[60vh] max-w-4xl place-items-center px-4 py-16">
      <div className="glass-panel rounded-[2rem] p-8 text-center">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-white">Bir şeyler ters gitti.</h1>
        <p className="mt-3 text-slate-300">Sayfayı tekrar denemek icin aşağıdaki butonu kullanabilirsin.</p>
