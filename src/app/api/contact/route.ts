...
export async function POST(request: Request) {
  ...
  if (!limited.ok) return contactError("Cok fazla mesaj denemesi.", 429);
  ...
  try {
    ...
    return contactError(isValidationError ? message : "Mesaj gonderilirken bir hata olustu.", isValidationError ? 400 : 500);
  }
}
